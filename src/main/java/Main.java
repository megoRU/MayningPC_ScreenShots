...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    for (; ;) {
      ...
      ImageIO.write(screenShot, "JPG", new File("src/main/resources/" + formatter.format(now.getTime()) + ".jpg"));
      System.out.println(formatter.format(now.getTime()));
      ChannelSftp channelSftp = setupJsch();
      channelSftp.connect();
      channelSftp.put("src/main/resources/" + formatter.format(now.getTime()) + ".jpg", folderSFTP + formatter.format(now.getTime()) + ".jpg");
      channelSftp.exit();
